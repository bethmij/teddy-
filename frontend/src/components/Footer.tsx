      ...
      <div className="flex flex-col md:flex-row items-start justify-center px-6 md:px-16 lg:px-32 gap-10 py-14 border-b border-gray-500/30 text-gray-500">
        <div className="w-4/5">
          ...
          <p className="mt-6 text-sm">
            Our toy collection brings joy and excitement to children of all ages. From educational toys to action figures, 
            ...
            Whether you're looking for the perfect gift or expanding a toy collection, we have something special for every child.
          </p>
        </div>
